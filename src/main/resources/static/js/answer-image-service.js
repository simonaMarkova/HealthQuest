 ...
 */
app.factory('answerImageService', AnswerImageServiceFn);

AnswerImageServiceFn.$inject = ['$http', '$q'];

/* @ngInject */
function AnswerImageServiceFn($http, $q) {

    var URL = 'http://localhost:7778/answerImage/';
